	...
	public static void main (String[] args) throws IOException
	 {
	    ...
	    while(t-->0){
			...
			i = 0;
			for (String numStr: line1.split("\\s")){
				a[i] = Integer.parseInt(numStr);
				i++;
			}
			
			i = 0;
			for (String numStr: line2.split("\\s")){
				b[i] = Integer.parseInt(numStr);
				i++;
			}
			
			System.out.println(countPairs(a, b, a.length, b.length));
	    }
	 }
}